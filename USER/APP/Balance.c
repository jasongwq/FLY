...
{
    angle.yaw = att_in->yaw + (rc_in->YAW   - 1500) / 20 + (-(*yaw_just - 10));
    if (angle.yaw < -180)
        angle.yaw += 360;
...
{
    angle.rol = att_in->rol - (rc_in->ROLL  - 1500) / 20 + (-(*rol_just - 10));
    /*****************************************************
    /P
    *****************************************************/
...
{
    angle.pit = att_in->pit + (rc_in->PITCH - 1500) / 20 + (+(*pit_just - 10));
    /*****************************************************
    /P
    *****************************************************/
